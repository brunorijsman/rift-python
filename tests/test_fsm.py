...
def test_history_table(dog):
    ...
    pattern = (
        ".----------.----------.----------.---------.---------.-------.---------------.---------.----------.\n"
        ". Sequence . Time     . Queue    . Verbose . From    . Event . Actions and   . To      . Implicit .\n"
        ". Nr       . Until    . Time     . Skipped . State   .       . Pushed Events . State   .          .\n"
        ".          . Next     .          .         .         .       .               .         .          .\n"
        ".----------.----------.----------.---------.---------.-------.---------------.---------.----------.\n"
    ...
    pattern = (
        ".----------.----------.----------.---------.-------.---------------.---------.----------.\n"
        ". Sequence . Time     . Queue    . From    . Event . Actions and   . To      . Implicit .\n"
        ". Nr       . Until    . Time     . State   .       . Pushed Events . State   .          .\n"
        ".          . Next     .          .         .       .               .         .          .\n"
        ".----------.----------.----------.---------.-------.---------------.---------.----------.\n"
