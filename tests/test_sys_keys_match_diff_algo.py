# System test: test_sys_keys_match_diff_algo
...
def check_rift_node1(res):
    ...
    expect_node_security = [
        ...
        r"| 0      | null         |                                  |",
        r"| 1      | sha-224      | this-is-the-secret-for-key-1     |",
        r"| 2      | sha-256      | this-is-the-secret-for-key-2     |",
        r"| 3      | sha-512      | this-is-the-secret-for-key-3     |",
        r"| 4      | hmac-sha-256 | this-is-the-secret-for-key-4     |",
        r"| 66051  | hmac-sha-1   | this-is-the-secret-for-key-66051 |",
        r"Origin Keys:",
...
def test_keys_match():
    ...
    res = RiftExpectSession("keys_match_diff_algo")
