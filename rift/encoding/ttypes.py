...
class LinkIDPair(object):
    ...
    Attributes:
     ...
     - trusted_outer_security_key: optional indication whether the link is secured, i.e. protected by outer key, absence
    ...
    def __init__(self, local_id=None, remote_id=None, platform_interface_index=None, platform_interface_name=None, trusted_outer_security_key=None,):
        self.local_id = local_id
        self.remote_id = remote_id
