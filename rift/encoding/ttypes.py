...
class PacketHeader(object):
    ...
    def __init__(self, major_version=15, minor_version=0, sender=None, level=None,):
...
class LIEPacket(object):
    ...
    def __init__(self, name=None, local_id=None, flood_port=912, link_mtu_size=1400, link_bandwidth=100, neighbor=None, pod=0, nonce=None, last_neighbor_nonce=None, capabilities=None, holdtime=3, not_a_ztp_offer=False, you_are_flood_repeater=True, label=None,):
        self.name = name
...
class TIEHeader(object):
    ...
    def write(self, oprot):
        ...
        if self.remaining_lifetime is not None:
            oprot.writeFieldBegin('remaining_lifetime', TType.I32, 4)
...
LIEPacket.thrift_spec = (
    ...
    (10, TType.STRUCT, 'capabilities', [NodeCapabilities, None], None, ),  # 10
...
TIEHeader.thrift_spec = (
    ...
    (4, TType.I32, 'remaining_lifetime', None, None, ),  # 4
    None,  # 5
    None,  # 6
    None,  # 7
    None,  # 8
