...
class PacketHeader(object):
    ...
    def __init__(self, major_version=4, minor_version=1, sender=None, level=None,):
...
class NodeCapabilities(object):
    ...
    def __init__(self, protocol_minor_version=1, flood_reduction=True, hierarchy_indications=None,):
...
class LinkCapabilities(object):
    ...
    Attributes:
     ...
     - v4_forwarding_capable: Indicates whether the interface will support v4 forwarding.
    ...
    def __init__(self, bfd=True, v4_forwarding_capable=True,):
        self.bfd = bfd
        self.v4_forwarding_capable = v4_forwarding_capable
...
class LIEPacket(object):
    ...
    3-way connectivity.
     - pod: Node's PoD.
     - node_capabilities: Node capabilities shown in LIE. The capabilities
    ...
    MUST expire without LIE for the adjacency to drop.
     - label: Unsolicited, downstream assigned locally significant label
    ...
    from a northbound adjacency.
     - you_are_sending_too_quickly: Can be optionally set to indicate to neighbor that packet losses
    ...
    def __init__(self, name=None, local_id=None, flood_port=915, link_mtu_size=1400, link_bandwidth=100, neighbor=None, pod=0, node_capabilities=None, link_capabilities=None, holdtime=3, label=None, not_a_ztp_offer=False, you_are_flood_repeater=True, you_are_sending_too_quickly=False, instance_name=None,):
        self.name = name
...
class LinkIDPair(object):
    ...
    Attributes:
     ...
     - trusted_outer_security_key: Indication whether the link is secured, i.e. protected by
    outer key, absence of this element means no indication,
    undefined outer key means not secured.
     - bfd_up: Indication whether the link is protected by established
    BFD session.
    ...
    def __init__(self, local_id=None, remote_id=None, platform_interface_index=None, platform_interface_name=None, trusted_outer_security_key=None, bfd_up=None, address_families=None,):
        ...
        self.trusted_outer_security_key = trusted_outer_security_key
        self.bfd_up = bfd_up
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BYTE:
                    self.trusted_outer_security_key = iprot.readByte()
                else:
                    iprot.skip(ftype)
            elif fid == 13:
                if ftype == TType.BOOL:
                    self.bfd_up = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 14:
                if ftype == TType.SET:
                    ...
                    for _i4 in range(_size0):
                        ...
                        self.address_families.add(_elem5)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class NodeFlags(object):
    ...
    def __init__(self, overload=False,):
...
class NodeTIEElement(object):
    ...
    Attributes:
     ...
     - neighbors: Node's neighbors. If neighbor systemID repeats in other
    ...
    def __init__(self, level=None, neighbors=None, capabilities=None, flags=None, name=None, pod=None, startup_time=None, miscabled_links=None,):
        self.level = level
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i32 in range(_size28):
                        ...
                        _val34 = NodeNeighborsTIEElement()
                        _val34.read(iprot)
                        self.neighbors[_key33] = _val34
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.I64:
                    self.startup_time = iprot.readI64()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.SET:
                    ...
                    for _i39 in range(_size35):
                        ...
                        self.miscabled_links.add(_elem40)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.neighbors is not None:
            ...
            for kiter41, viter42 in self.neighbors.items():
        ...
        if self.miscabled_links is not None:
            ...
            for iter43 in self.miscabled_links:
...
class PrefixAttributes(object):
    ...
    analytics.
     ...
     - loopback: Indicates if the interface is a node loopback.
     - directly_attached: Indicates that the prefix is directly attached, i.e. should be
    routed to even if the node is in overload.
     - from_link: In case of locally originated prefixes, i.e. interface
    ...
    def __init__(self, metric=1, tags=None, monotonic_clock=None, loopback=False, directly_attached=True, from_link=None,):
...
class KeyValueTIEElement(object):
    ...
    Attributes:
     - keyvalues: @note: if the same key repeats in multiple TIEs of same node
...
class TIEElement(object):
    ...
    def __init__(self, node=None, prefixes=None, positive_disaggregation_prefixes=None, negative_disaggregation_prefixes=None, external_prefixes=None, positive_external_disaggregation_prefixes=None, keyvalues=None,):
        ...
        self.positive_external_disaggregation_prefixes = positive_external_disaggregation_prefixes
        self.keyvalues = keyvalues
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.positive_external_disaggregation_prefixes = PrefixTIEElement()
                    self.positive_external_disaggregation_prefixes.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.STRUCT:
...
PacketHeader.thrift_spec = (
    None,  # 0
    (1, TType.BYTE, 'major_version', None, 4, ),  # 1
...
LinkCapabilities.thrift_spec = (
    ...
    (2, TType.BOOL, 'v4_forwarding_capable', None, True, ),  # 2
)
...
LinkIDPair.thrift_spec = (
    ...
    (14, TType.SET, 'address_families', (TType.I32, None, False), None, ),  # 14
)
...
TIDEPacket.thrift_spec = (
    ...
    (3, TType.LIST, 'headers', (TType.STRUCT, [TIEHeaderWithLifeTime, None], False), None, ),  # 3
)
all_structs.append(TIREPacket)
TIREPacket.thrift_spec = (
    None,  # 0
    (1, TType.SET, 'headers', (TType.STRUCT, [TIEHeaderWithLifeTime, None], False), None, ),  # 1
)
...
NodeNeighborsTIEElement.thrift_spec = (
    ...
    (4, TType.SET, 'link_ids', (TType.STRUCT, [LinkIDPair, None], False), None, ),  # 4
