...
class PacketHeader(object):
    ...
    def __init__(self, major_version=11, minor_version=0, sender=None, level=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.I16:
                    self.major_version = iprot.readI16()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.I16:
    ...
    def write(self, oprot):
        ...
        if self.major_version is not None:
            oprot.writeFieldBegin('major_version', TType.I16, 1)
            oprot.writeI16(self.major_version)
            oprot.writeFieldEnd()
...
class NodeCapabilities(object):
    ...
    def __init__(self, flood_reduction=True, leaf_indications=None,):
...
class LIEPacket(object):
    ...
    3-way connectivity
     - pod
     - nonce: optional nonce used for security computations
    ...
    to derive a ZTP level by the receiving node.
     - you_are_not_flood_repeater: indicates to northbound neighbor that it should not
    ...
    def __init__(self, name=None, local_id=None, flood_port=912, link_mtu_size=1400, neighbor=None, pod=0, nonce=None, capabilities=None, holdtime=3, not_a_ztp_offer=False, you_are_not_flood_repeater=False, label=None,):
        self.name = name
        ...
        if pod is self.thrift_spec[6][4]:
            pod = 0
        self.pod = pod
        self.nonce = nonce
        self.capabilities = capabilities
        if holdtime is self.thrift_spec[9][4]:
            holdtime = 3
        self.holdtime = holdtime
        self.not_a_ztp_offer = not_a_ztp_offer
        self.you_are_not_flood_repeater = you_are_not_flood_repeater
        self.label = label
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.you_are_not_flood_repeater = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                if ftype == TType.I32:
    ...
    def write(self, oprot):
        ...
        if self.neighbor is not None:
            oprot.writeFieldBegin('neighbor', TType.STRUCT, 5)
        ...
        if self.nonce is not None:
            oprot.writeFieldBegin('nonce', TType.I64, 7)
            oprot.writeI64(self.nonce)
            oprot.writeFieldEnd()
        if self.capabilities is not None:
            oprot.writeFieldBegin('capabilities', TType.STRUCT, 8)
            self.capabilities.write(oprot)
            oprot.writeFieldEnd()
        if self.holdtime is not None:
            oprot.writeFieldBegin('holdtime', TType.I16, 9)
            oprot.writeI16(self.holdtime)
            oprot.writeFieldEnd()
        if self.not_a_ztp_offer is not None:
            oprot.writeFieldBegin('not_a_ztp_offer', TType.BOOL, 10)
            oprot.writeBool(self.not_a_ztp_offer)
            oprot.writeFieldEnd()
        if self.you_are_not_flood_repeater is not None:
            oprot.writeFieldBegin('you_are_not_flood_repeater', TType.BOOL, 11)
            oprot.writeBool(self.you_are_not_flood_repeater)
            oprot.writeFieldEnd()
...
class LinkIDPair(object):
    ...
    def __init__(self, local_id=None, remote_id=None,):
        self.local_id = local_id
        self.remote_id = remote_id
...
class TIEHeader(object):
    ...
    Attributes:
     - tieid
     - seq_nr
     - lifetime: lifetime expires down to 0 just like in ISIS
    """


    def __init__(self, tieid=None, seq_nr=None, lifetime=None,):
        self.tieid = tieid
        self.seq_nr = seq_nr
    ...
    def write(self, oprot):
        ...
        if self.seq_nr is not None:
            oprot.writeFieldBegin('seq_nr', TType.I32, 3)
            oprot.writeI32(self.seq_nr)
            oprot.writeFieldEnd()
    ...
    def validate(self):
        ...
        if self.lifetime is None:
            raise TProtocolException(message='Required field lifetime is unset!')
        return
...
class NodeNeighborsTIEElement(object):
    ...
    def write(self, oprot):
        ...
        if self.level is not None:
            oprot.writeFieldBegin('level', TType.I16, 1)
            oprot.writeI16(self.level)
            oprot.writeFieldEnd()
...
class NodeTIEElement(object):
    ...
    def __init__(self, level=None, neighbors=None, capabilities=None, flags=None, name=None, visible_in_same_level=set((
...
class PrefixAttributes(object):
    ...
    Attributes:
     - metric
     - tags: generic unordered set of route tags, can be redistributed to
    ...
    def __init__(self, metric=1, tags=None, monotonic_clock=None,):
...
class TIEElement(object):
    ...
    Attributes:
     ...
     - transitive_prefixes: transitive prefixes (always southbound) which SHOULD be propagated
...
PacketHeader.thrift_spec = (
    None,  # 0
    (1, TType.I16, 'major_version', None, 11, ),  # 1
...
LIEPacket.thrift_spec = (
    ...
    (5, TType.STRUCT, 'neighbor', [Neighbor, None], None, ),  # 5
    (6, TType.I32, 'pod', None, 0, ),  # 6
    (7, TType.I64, 'nonce', None, None, ),  # 7
    (8, TType.STRUCT, 'capabilities', [NodeCapabilities, None], None, ),  # 8
    (9, TType.I16, 'holdtime', None, 3, ),  # 9
    (10, TType.BOOL, 'not_a_ztp_offer', None, False, ),  # 10
    (11, TType.BOOL, 'you_are_not_flood_repeater', None, False, ),  # 11
...
TIEHeader.thrift_spec = (
    ...
    (3, TType.I32, 'seq_nr', None, None, ),  # 3
    (4, TType.I32, 'lifetime', None, None, ),  # 4
)
...
TIDEPacket.thrift_spec = (
    ...
    (3, TType.LIST, 'headers', (TType.STRUCT, [TIEHeader, None], False), None, ),  # 3
)
all_structs.append(TIREPacket)
TIREPacket.thrift_spec = (
    None,  # 0
    (1, TType.SET, 'headers', (TType.STRUCT, [TIEHeader, None], False), None, ),  # 1
)
all_structs.append(NodeNeighborsTIEElement)
NodeNeighborsTIEElement.thrift_spec = (
    None,  # 0
    (1, TType.I16, 'level', None, None, ),  # 1
    None,  # 2
...
TIEElement.thrift_spec = (
    ...
    (3, TType.STRUCT, 'transitive_prefixes', [PrefixTIEElement, None], None, ),  # 3
    (4, TType.STRUCT, 'keyvalues', [KeyValueTIEElement, None], None, ),  # 4
)
