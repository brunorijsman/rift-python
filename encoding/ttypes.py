...
class PacketHeader(object):
    ...
    Attributes:
     - major_version: major version type of protocol
     - minor_version: minor version type of protocol
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.BYTE, 'major_version', None, 2, ),  # 1
...
class NodeCapabilities(object):
    ...
    def __init__(self, protocol_minor_version=thrift_spec[1][4], flood_reduction=thrift_spec[2][4], hierarchy_indications=None,):
...
class LinkCapabilities(object):
    ...
    Attributes:
     ...
     - v4_forwarding_capable: indicates whether the interface will support v4 forwarding. This MUST
    ...
    def __init__(self, bfd=thrift_spec[1][4], v4_forwarding_capable=thrift_spec[2][4],):
        self.bfd = bfd
...
class LIEPacket(object):
    ...
    3-way connectivity
     - pod: node's PoD
     - node_capabilities: node capabilities shown in the LIE. The capabilies
    ...
    temporarily slow down flooding rates
     - instance_name: instance name in case multiple RIFT instances running on same interface
    """
...
class LinkIDPair(object):
    ...
    Attributes:
     ...
     - trusted_outer_security_key: indication whether the link is secured, i.e. protected by outer key, absence
    of this element means no indication, undefined outer key means not secured
     - bfd_up: indication whether the link is protected by established BFD session
    """
    ...
    def __init__(self, local_id=None, remote_id=None, platform_interface_index=None, platform_interface_name=None, trusted_outer_security_key=None, bfd_up=None,):
        self.local_id = local_id
        self.remote_id = remote_id
...
class NodeFlags(object):
    ...
    Attributes:
     - overload: indicates that node is in overload, do not transit traffic through it
    """
...
class NodeTIEElement(object):
    ...
    Attributes:
     ...
     - neighbors: node's neighbors. If neighbor systemID repeats in other node TIEs of
