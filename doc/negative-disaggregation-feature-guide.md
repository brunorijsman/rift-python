...
|                          |      |         | System IDs  |      |              |                      |                                  |
+--------------------------+------+---------+-------------+------+--------------+----------------------+----------------------------------+
| 1 (super-1-1)            | 1    | False   | 107         |      |              | if-107d 172.31.60.58 | if-107d fe80::cfc:a3ff:fe0e:36b4 |
+--------------------------+------+---------+-------------+------+--------------+----------------------+----------------------------------+
| 2 (super-1-2)            | 1    | False   | 107         |      |              | if-107e 172.31.60.58 | if-107e fe80::cfc:a3ff:fe0e:36b4 |
+--------------------------+------+---------+-------------+------+--------------+----------------------+----------------------------------+
| 107 (spine-3-1)          | 0    | False   |             |      |              |                      |                                  |
+--------------------------+------+---------+-------------+------+--------------+----------------------+----------------------------------+
| 0.0.0.0/0                | 2    | False   | 1           |      |              | if-107d 172.31.60.58 | if-107d fe80::cfc:a3ff:fe0e:36b4 |
|                          |      |         | 2           |      |              | if-107e 172.31.60.58 | if-107e fe80::cfc:a3ff:fe0e:36b4 |
+--------------------------+------+---------+-------------+------+--------------+----------------------+----------------------------------+
| 89.0.7.1/32              | 1    | False   | 107         |      |              |                      |                                  |
+--------------------------+------+---------+-------------+------+--------------+----------------------+----------------------------------+
| ::/0                     | 2    | False   | 1           |      |              | if-107d 172.31.60.58 | if-107d fe80::cfc:a3ff:fe0e:36b4 |
|                          |      |         | 2           |      |              | if-107e 172.31.60.58 | if-107e fe80::cfc:a3ff:fe0e:36b4 |
+--------------------------+------+---------+-------------+------+--------------+----------------------+----------------------------------+
| 88.0.1.1/32 (Pos-Disagg) | 4    | False   | 2           |      | Positive     | if-107e 172.31.60.58 | if-107e fe80::cfc:a3ff:fe0e:36b4 |
+--------------------------+------+---------+-------------+------+--------------+----------------------+----------------------------------+
| 88.0.2.1/32 (Pos-Disagg) | 4    | False   | 2           |      | Positive     | if-107e 172.31.60.58 | if-107e fe80::cfc:a3ff:fe0e:36b4 |
+--------------------------+------+---------+-------------+------+--------------+----------------------+----------------------------------+
| 88.0.3.1/32 (Pos-Disagg) | 4    | False   | 2           |      | Positive     | if-107e 172.31.60.58 | if-107e fe80::cfc:a3ff:fe0e:36b4 |
+--------------------------+------+---------+-------------+------+--------------+----------------------+----------------------------------+
| 89.0.1.1/32 (Pos-Disagg) | 3    | False   | 2           |      | Positive     | if-107e 172.31.60.58 | if-107e fe80::cfc:a3ff:fe0e:36b4 |
+--------------------------+------+---------+-------------+------+--------------+----------------------+----------------------------------+
</pre>
...
|        |           | Type     | Interface | Address                  | Weight   |
+--------+-----------+----------+-----------+--------------------------+----------+
| ::/0   | North SPF | Positive | if-1007a  | fe80::cfc:a3ff:fe0e:36b4 |          |
|        |           | Positive | if-1007b  | fe80::cfc:a3ff:fe0e:36b4 |          |
|        |           | Positive | if-1007c  | fe80::cfc:a3ff:fe0e:36b4 |          |
+--------+-----------+----------+-----------+--------------------------+----------+
</pre>
...
|        | Type     | Interface | Address                  | Weight   |
+--------+----------+-----------+--------------------------+----------+
| ::/0   | Positive | if-1007a  | fe80::cfc:a3ff:fe0e:36b4 |          |
|        | Positive | if-1007b  | fe80::cfc:a3ff:fe0e:36b4 |          |
|        | Positive | if-1007c  | fe80::cfc:a3ff:fe0e:36b4 |          |
+--------+----------+-----------+--------------------------+----------+
</pre>
...
|             |           | Positive | if-107e   | 172.31.60.58 |          |
+-------------+-----------+----------+-----------+--------------+----------+
| 88.0.1.1/32 | North SPF | Negative | if-107d   | 172.31.60.58 |          |
|             |           | Negative | if-107e   | 172.31.60.58 |          |
+-------------+-----------+----------+-----------+--------------+----------+
| 88.0.2.1/32 | North SPF | Negative | if-107d   | 172.31.60.58 |          |
|             |           | Negative | if-107e   | 172.31.60.58 |          |
+-------------+-----------+----------+-----------+--------------+----------+
| 88.0.3.1/32 | North SPF | Negative | if-107d   | 172.31.60.58 |          |
|             |           | Negative | if-107e   | 172.31.60.58 |          |
+-------------+-----------+----------+-----------+--------------+----------+
| 88.0.7.1/32 | South SPF | Positive | if-107a   | 172.31.60.58 |          |
+-------------+-----------+----------+-----------+--------------+----------+
...
any next-hops, which means that they are actually discard routes.
